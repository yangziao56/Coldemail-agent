...
flowchart TD
  ...
  pref_q --> ctx_prefs["Context P (Targeting prefs)<br/>Q&A transcript / filters"]
  ctx_prefs --> rec_call["Search people: POST /api/find-recommendations<br/>(Gemini Search grounding by default)"]
